...
TreasureModels = {
  ...
  TreasureCZ: (
        'phase_5.5/models/estate/shovels',
        'phase_4/audio/sfx/SZ_DD_treasure.ogg',
    ),
}
...
SafeZoneTreasureSpawns = {
    ToontownGlobals.ToontownCentral: (
        ...
        [
            ...
            (-28.6272, 85.9833, 1.022),
            (-96.0629, 76.3099, 0.355),
            (-136.296, 32.794, 1.022),
        ],
        10, # Rate
        10 # Maximum
    ),
    ToontownGlobals.DonaldsDock: (
        TreasureDD, 8, # DDTreasure heals 8 each...
        [
 ...
 ToontownGlobals.ConstructionZone: (
        TreasureCZ, 18, # +18 laff
        [
            (-156.9, -118.9, 3.725),
            (3.6, 211.0, 26.0),
            (-280.8, 222.8, -23.404), #Pond
            (-325.0, 146.0, -25.1),   #Pond
            (-0.262, -129.38, 43.2), #Middle Brick
            (137.1, -12.5, 91.809),  #Top Brick
            (33.0, 132.1, 4.28),
            (-82.02, -62.2, 6.026), #Bottom Brick
            (-176.9, 144.5, 3.625),
            (-226.7, -27.6, 3.825),
            (225.0, -58.0, 3.373),
            (201.0, -185.0, 5.4),
