...
class QuestPoster(DirectFrame):
    ...
    def loadElevator(self, building, numFloors):
        ...
        elevatorModel = loader.loadModel('phase_4/models/modules/elevator7')
        floorIndicator = [None] * 10
    ...
    def teleportToShop(self, npcId):
        ...
        hqZone = {2000:2520, 1000:1507, 3000:3508, 4000:4504, 5000:5502, 7000:7503, 9000:9505, 14000:14520}
    ...
    def update(self, questDesc):
        ...
        if isinstance(quest, Quests.TexturedQuest) and quest.hasFrame():
                ...
                if holder == Quests.Any:
                    ...
                    if holderType == 'track':
                        ...
                        if holder == 'c':
                            ...
                            icon = cogIcons.find('**/GovernIcon')
                        elif holder == 'e':
                            icon = cogIcons.find('**/EurekaIcon')
                        elif holder == 'b':
                            icon = cogIcons.find('**/BuildIcon')
                        elif holder == 'z':
                            icon = cogIcons.find('**/ViralIcon')    
            ...
            if track == 'c':
                ...
                lIconGeom = loader.loadModel('phase_4/models/modules/suit_landmark_govern')
            elif track == 'e':
                lIconGeom = loader.loadModel('phase_4/models/modules/suit_landmark_eureka')
            elif track == 'b':
                lIconGeom = loader.loadModel('phase_4/models/modules/suit_landmark_build')
            elif track == 'z':
                lIconGeom = loader.loadModel('phase_4/models/modules/suit_landmark_viral')
            else:
                bookModel = loader.loadModel('phase_3.5/models/gui/stickerbook_gui')
