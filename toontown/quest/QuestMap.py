...
class QuestMap(DirectFrame):
    ...
    def load(self):
        ...
        vIcon = icons.find('**/GovernIcon')
        eIcon = icons.find('**/EurekaIcon')
        bIcon = icons.find('**/BuildIcon')
        zIcon = icons.find('**/ViralIcon')
        ...
        self.vInfo = DirectLabel(parent=self.cogInfoFrame, text_fg=cogInfoTextColor, text='', text_pos=textPos, text_scale=textScale, geom=vIcon, geom_pos=(-0.2, 0, 0), geom_scale=0.8, relief=None)
        self.vInfo.setPos(-2.2, 0, -1.5)
        self.eInfo = DirectLabel(parent=self.cogInfoFrame, text_fg=cogInfoTextColor, text='', text_pos=textPos, text_scale=textScale, geom=eIcon, geom_pos=(-0.2, 0, 0), geom_scale=0.8, relief=None)
        self.eInfo.setPos(0.8, 0, -1.5)
        self.bInfo = DirectLabel(parent=self.cogInfoFrame, text_fg=cogInfoTextColor, text='', text_pos=textPos, text_scale=textScale, geom=bIcon, geom_pos=(-0.2, 0, 0), geom_scale=0.8, relief=None)
        self.bInfo.setPos(-2.2, 0, -2.5)
        self.zInfo = DirectLabel(parent=self.cogInfoFrame, text_fg=cogInfoTextColor, text='', text_pos=textPos, text_scale=textScale, geom=zIcon, geom_pos=(-0.2, 0, 0), geom_scale=0.8, relief=None)
        self.zInfo.setPos(0.8, 0, -2.5)
        icons.removeNode()
        return
    ...
    def updateCogInfo(self):
        ...
        self.vInfo['text'] = '%s%%' % currPercentage[4]
        self.eInfo['text'] = '%s%%' % currPercentage[5]
        self.bInfo['text'] = '%s%%' % currPercentage[6]
        self.zInfo['text'] = '%s%%' % currPercentage[7]
        return
