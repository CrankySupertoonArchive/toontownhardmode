...
FO_DICT = {'s': 'tt_m_ara_cbe_fieldOfficeMoverShaker',
 ...
 'v': 'tt_m_ara_cbe_fieldOfficeLegalEagle',
 'e': 'tt_m_ara_cbe_fieldOfficeMoverShaker',
 'b': 'tt_m_ara_cbe_fieldOfficeLegalEagle',
 'z': 'tt_m_ara_cbe_fieldOfficeLegalEagle'}
...
class DistributedBuilding(DistributedObject.DistributedObject):
    ...
    def loadElevator(self, newNP, cogdo = False):
        ...
        if cogdo:
            ...
            self.elevatorModel = loader.loadModel('phase_4/models/modules/elevator7')
        ...
        if self.mode == 'suit':
            ...
            if dept == 'c':
                ...
                corpIcon = cogIcons.find('**/GovernIcon').copyTo(self.cab)
            elif dept == 'e':
                corpIcon = cogIcons.find('**/EurekaIcon').copyTo(self.cab)
            elif dept == 'b':
                corpIcon = cogIcons.find('**/BuildIcon').copyTo(self.cab)
            elif dept == 'z':
                corpIcon = cogIcons.find('**/ViralIcon').copyTo(self.cab)
