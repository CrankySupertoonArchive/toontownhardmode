...
class DistributedFactoryElevatorExt(DistributedElevatorExt.DistributedElevatorExt):
    ...
    def setEntranceId(self, entranceId):
        ...
        elif self.entranceId == 3 and base.config.GetBool('want-hardfactory', True):
            self.elevatorModel.setPosHpr(17.765, -43.83, 0.0, -88.0, 0.0, 0.0)
        elif self.entranceId == 4 and base.config.GetBool('want-unfairfactory', True):
            self.elevatorModel.setPosHpr(-104.03, 26.43, 0.0, 89.0, 0.0, 0.0)
        else:
