...
GlobalEntities = {1000: {'type': 'levelMgr',
 ...
 60118: {'type': 'button',
         ...
         'secondsOn': -1.0},
 70000: {'type': 'button',
         'name': 'Warehouse Lookout Switch',
         'comment': '',
         'parentEntId': 23,
         'pos': Point3(18.608, -51.797, 0.043),
         'hpr': Vec3(180, 0, 0),
         'scale': Vec3(3, 3, 3),
         'color': Vec4(1, 0, 0, 1),
         'isOn': 0,
         ...
         'secondsOn': -1.0},
 70001: {'type': 'button',
         'name': 'Paint Mixer Reward Switch',
         'comment': '',
         'parentEntId': 11,
         'pos': Point3(4.273, 22.369, 0.025),
         'hpr': Vec3(0, 0, 0),
         'scale': Vec3(3, 3, 3),
         'color': Vec4(1, 0, 0, 1),
         'isOn': 0,
         ...
         'secondsOn': -1.0},
 70002: {'type': 'button',
         'name': 'Side Entrance Switch',
         'comment': '',
         'parentEntId': 16,
         'pos': Point3(0, -15, 0.025),
         'hpr': Vec3(180, 0, 0),
         'scale': Vec3(3, 3, 3),
         'color': Vec4(1, 0, 0, 1),
         'isOn': 0,
         ...
         'secondsOn': -1.0},
 70003: {'type': 'button',
         'name': 'Lava Reward Room Switch',
         'comment': '',
         'parentEntId': 20,
         'pos': Point3(4.636, 19.337, 0.025),
         'hpr': Vec3(0, 0, 0),
         'scale': Vec3(3, 3, 3),
         'color': Vec4(1, 0, 0, 1),
         'isOn': 0,
         ...
         'secondsOn': -1.0},
 80000: {'type': 'button',
         'name': 'Hidden Switch 1 - Stomper Alley',
         'comment': '',
         'parentEntId': 17,
         'pos': Point3(18.961, -3.140, 0.025),
         'hpr': Vec3(0, 0, 0),
         'scale': Vec3(3, 3, 3),
         ...
         'secondsOn': -1.0},
 80001: {'type': 'button',
         'name': 'Hidden Switch 2 - Pipe Room',
         'comment': '',
         'parentEntId': 13,
         'pos': Point3(13.652, 131.347, 0.025),
         'hpr': Vec3(0, 0, 0),
         'scale': Vec3(3, 3, 3),
         'color': Vec4(0.5, 0.0, 0.1, 1),
         'isOn': 0,
         'isOnEvent': 0,
         'secondsOn': -1.0},
 80002: {'type': 'button',
         'name': 'Hidden Switch 3 - Paint Mixer',
         'comment': '',
         'parentEntId': 10,
         'pos': Point3(-15.902, -29.200, -1.975),
         'hpr': Vec3(-180, 0, 0),
         'scale': Vec3(3, 3, 3),
         'color': Vec4(0.8, 0.3, 0.8, 1),
         'isOn': 0,
         'isOnEvent': 0,
         'secondsOn': -1.0},
 80003: {'type': 'button',
         'name': 'Hidden Switch 4 - Warehouse',
         'comment': '',
         'parentEntId': 24,
         'pos': Point3(-35, -70, 0.025),
         'hpr': Vec3(90, 0, 0),
         'scale': Vec3(3, 3, 3),
         'color': Vec4(0.5, 0.0, 0.1, 1),
         'isOn': 0,
 ...
 85000: {'type': 'model',
         'name': 'backCrate',
         'comment': 'Crate that blocks off Secret Warehouse Storage',
         'parentEntId': 24,
         'pos': Point3(31.265, -35.267, 0.024),
         'hpr': Vec3(-180, 0, 0),
         'scale': Point3(2, 2, 5),
         'collisionsOnly': 0,
         'flattenType': 'light',
 ...
 85001: {'type': 'model',
         'name': 'backCrate',
         'comment': 'Crate that hides Hidden Switch 4',
         'parentEntId': 24,
         'pos': Point3(-37.042, -60.494, 0.014),
         'hpr': Vec3(90, 0, 0),
         'scale': Point3(2, 2, 5),
         'collisionsOnly': 0,
         'flattenType': 'light',
 ...
 85002: {'type': 'model',
         'name': 'backCrate',
         'comment': 'Crate that blocks access to the Secret Warehouse Storage from the Button Platform',
         'parentEntId': 24,
         'pos': Point3(20.801, -53.835, 16.081),
         'hpr': Vec3(0, 0, 0),
         'scale': Point3(0.5, 8, 8),
         'collisionsOnly': 0,
         'flattenType': 'light',
         'loadType': 'loadModelCopy',
         'modelPath': 'phase_9/models/cogHQ/metal_crateB.bam'},
 ...
 30009: {'type': 'door',
         ...
         'unlock3Event': 0},
 30010: {'type': 'door',
         'name': 'Warehouse East Entrance Door',
         'comment': '',
         'parentEntId': 115,
         'pos': Point3(0, 0, 0),
         'hpr': Vec3(0, 0, 0),
 ...
 10332: {'type': 'entrancePoint',
         ...
         'radius': 15,
         'theta': 20},
 86000: {'type': 'healBarrel',
         'name': 'Hidden Warehouse Restock Barrel 1',
         'comment': '',
         'parentEntId': 24,
         'pos': Point3(46.358, -70.440, 0.004),
         'hpr': Vec3(-150.608, 0, 0),
         'scale': 1,
         'rewardPerGrab': 25,
         'rewardPerGrabMax': 0},
 86001: {'type': 'healBarrel',
         'name': 'Hidden Warehouse Restock Barrel 2',
         'comment': '',
         'parentEntId': 24,
         'pos': Point3(24.220, -72.936, 0.003),
         'hpr': Vec3(115.465, 0, 0),
         'scale': 1,
         'rewardPerGrab': 25,
         'rewardPerGrabMax': 0},
 86002: {'type': 'gagBarrel',
         'name': 'Hidden Warehouse Restock Barrel 3',
         'comment': '',
         'parentEntId': 24,
         'pos': Point3(24, -48.610, 0.021),
         'hpr': Vec3(36.904, 0, 0),
         'scale': 1,
         'gagLevel': 6,
         'gagLevelMax': 0,
         ...
         'rewardPerGrab': 3,
         'rewardPerGrabMax': 7},
 86003: {'type': 'gagBarrel',
         'name': 'Hidden Warehouse Restock Barrel 4',
         'comment': '',
         'parentEntId': 24,
         'pos': Point3(47, -42.513, 0.024),
         'hpr': Vec3(-54.079, 0, 0),
         'scale': 1,
         'gagLevel': 6,
         'gagLevelMax': 0,
         ...
         'rewardPerGrab': 3,
         'rewardPerGrabMax': 7},
 86004: {'type': 'gagBarrel',
         'name': 'Hidden Warehouse Restock Barrel 5',
         'comment': '',
         'parentEntId': 24,
         'pos': Point3(28.738, -44.394, 0.024),
         'hpr': Vec3(67.686, 0, 0),
         'scale': 1,
         'gagLevel': 6,
         'gagLevelMax': 0,
 ...
 40002: {'type': 'nodepath',
         'name': 'cogs',
         'comment': 'Lava Room Storage Room',
         'parentEntId': 20,
         'pos': Point3(0, 7.2, 0),
         'hpr': Vec3(-180, 0, 0),
         'scale': 1},
 ...
 40004: {'type': 'nodepath',
         'name': 'cogs',
         'comment': 'West Silo Control Room Cogs',
         'parentEntId': 31,
         'pos': Point3(0, 0, 0),
         'hpr': Vec3(0, 0, 0),
         'scale': 1},
 40005: {'type': 'nodepath',
         'name': 'cogs',
         'comment': 'East Silo Control Room Cogs',
         'parentEntId': 30,
         'pos': Point3(0, 0, 0),
         'hpr': Vec3(0, 0, 0),
         'scale': 1},
 40006: {'type': 'nodepath',
         'name': 'cogs',
         'comment': 'Warehouse Main Floor Cogs',
         'parentEntId': 24,
         'pos': Point3(0, -30, 0),
         'hpr': Point3(0, 0, 0),
         'scale': 1},
 40007: {'type': 'nodepath',
         'name': 'cogs',
         'comment': 'Gear Room Cogs - Set 2',
         'parentEntId': 7,
         'pos': Point3(-43.299, -15.014, 10.099),
         'hpr': Point3(270, 0, 0),
         'scale': 1},
 40009: {'type': 'nodepath',
         'name': 'cogs',
         'comment': 'Pipe Room - Set 3',
         'parentEntId': 13,
         'pos': Point3(0, 94, 0.0),
         'hpr': Vec3(0, 0.0, 0.0),
 ...
 40010: {'type': 'nodepath',
         'name': 'cogs',
         'comment': 'Pipe Room - Set 4',
         'parentEntId': 13,
         'pos': Point3(0, -94, 0.0),
         'hpr': Point3(0, 0.0, 0.0),
         'scale': Vec3(1.0, 1.0, 1.0)},
 40011: {'type': 'nodepath',
         'name': 'cogs',
         'comment': 'Lobby Cogs - Set 2',
         'parentEntId': 4,
         'pos': Point3(2, -34, 0),
         'hpr': Point3(0, 0, 0),
         'scale': 1},
 ...
 40014: {'type': 'nodepath',
         'name': 'cogs',
         'comment': 'Warehouse Lookout Cogs',
         'parentEntId': 23,
         'pos': Point3(18.576, -27.279, 0),
         'hpr': Point3(180, 0, 0),
         'scale': 1},
 40015: {'type': 'nodepath',
         'name': 'cogs',
         'comment': 'West Catwalk 1st Set',
         'parentEntId': 21,
         'pos': Point3(251.031, 232.275, -4.988),
         'hpr': Point3(126.138, 0, 0),
         'scale': 1},
 40016: {'type': 'nodepath',
         'name': 'cogs',
         'comment': 'Warehouse Entrance Guard - West Entrance',
         'parentEntId': 24,
         'pos': Point3(-40.315, -55.978, 0),
         'hpr': Point3(-108.027, 0, 0),
         'scale': 1},
 40017: {'type': 'nodepath',
         'name': 'cogs',
         'comment': 'Warehouse Entrance Guard - East Entrance',
         'parentEntId': 24,
         'pos': Point3(37.456, -59.560, 0),
         'hpr': Point3(132.356, 0, 0),
         'scale': 1},
 40018: {'type': 'nodepath',
         'name': 'cogs',
         'comment': 'East Catwalk Cogs - Paint Mixer Guards',
         'parentEntId': 9,
         'pos': Point3(8.002, -78.058, -4.975),
         'hpr': Point3(-45, 0, 0),
         'scale': 1},
 40019: {'type': 'nodepath',
         'name': 'cogs',
         'comment': 'Boiler Room 2nd Set',
         'parentEntId': 8,
         'pos': Point3(-52.958, -1.754, 0.025),
         'hpr': Point3(90, 0, 0),
         'scale': 1},
 40020: {'type': 'nodepath',
         'name': 'cogs',
         'comment': 'Pipe Room Entrance Guard',
         'parentEntId': 21,
         'pos': Point3(225.980, 192.753, -4.988),
         'hpr': Point3(-180, 0, 0),
         'scale': 1},
 40021: {'type': 'nodepath',
         'name': 'cogs',
         'comment': 'Oil Room Hallway - First Cog',
         'parentEntId': 27,
         'pos': Point3(0, -52.173, -14.975),
         'hpr': Point3(0, 0, 0),
         'scale': 1},
 40022: {'type': 'nodepath',
         'name': 'cogs',
         'comment': 'Oil Room Hallway - Second Cog',
         'parentEntId': 27,
         'pos': Point3(14.267, 0.123, 0.025),
         'hpr': Point3(-90, 0, 0),
         'scale': 1},
 40023: {'type': 'nodepath',
         'name': 'cogs',
         'comment': 'Side Entrance Cogs',
         'parentEntId': 16,
 ...
 40024: {'type': 'nodepath',
         'name': 'cogs',
         'comment': 'Entrance Cogs',
         'parentEntId': 3,
         'pos': Point3(0.0, 14, 0.0),
         'hpr': Point3(0.0, 0.0, 0.0),
         'scale': Vec3(1.0, 1.0, 1.0)},
 50000: {'type': 'gagBarrel',
         'name': 'Warehouse Lookout Barrel',
         'comment': '',
         'parentEntId': 10022,
         'pos': Point3(24.301, -57.041, 0),
         'hpr': Vec3(-152.234, 0, 0),
         'scale': 1,
         'gagLevel': 6,
         'gagLevelMax': 0,
         'gagTrack': 'random',
