...
NumTreasures = {
 ...
 ToontownGlobals.ConstructionZone: 2
}
NumPenalties = {
 ...
 ToontownGlobals.ConstructionZone: 1
}
Obstacles = {
 ...
 ToontownGlobals.ConstructionZone: ((MinWall[0] / 2, MinWall[1] / 2),
                                    (MinWall[0] / 2, MaxWall[1] / 2),
                                    (MaxWall[0] / 2, MinWall[1] / 2),
                                    (MaxWall[0] / 2, MaxWall[1] / 2))
}
ObstacleShapes = {
 ...
 ToontownGlobals.ConstructionZone: False
}
