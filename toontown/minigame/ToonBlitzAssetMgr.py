...
class ToonBlitzAssetMgr(DirectObject):
    ...
    def load(self):
        ...
        governIcon = loader.loadModel('phase_4/models/minigames/governIcon')
        self.treasureModelList.append(governIcon)
        eurekaIcon = loader.loadModel('phase_4/models/minigames/eurekaIcon')
        self.treasureModelList.append(eurekaIcon)
        buildIcon = loader.loadModel('phase_4/models/minigames/buildIcon')
        self.treasureModelList.append(buildIcon)
        viralIcon = loader.loadModel('phase_4/models/minigames/viralIcon')
        self.treasureModelList.append(viralIcon)
