...
from toontown.shtiker import NewSuitPage
...
class LocalToon(DistributedToon.DistributedToon, LocalAvatar.LocalAvatar):
    ...
    def initInterface(self):
        ...
        self.newSuitPage = NewSuitPage.NewSuitPage()
        self.newSuitPage.load()
        self.book.addPage(self.newSuitPage, pageName=TTLocalizer.NewSuitPageTitle)
