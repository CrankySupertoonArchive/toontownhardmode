...
class DistributedToon(DistributedPlayer.DistributedPlayer, Toon.Toon, DistributedSmoothNode.DistributedSmoothNode, DelayDeletable):
    ...
    def __init__(self, cr, bFake = False):
        ...
        self.cogLevels = [0, 0, 0, 0, 0, 0, 0, 0]
        self.cogParts = [0, 0, 0, 0, 0, 0, 0, 0]
        self.cogMerits = [0, 0, 0, 0, 0, 0, 0, 0]
    ...
    def setCogCount(self, cogCountList):
        ...
        elif hasattr(self, 'newSuitPage'):
            self.newSuitPage.updatePage()
    ...
    def setCogRadar(self, radar):
        ...
        if hasattr(self, 'suitPage'):
            ...
            self.newSuitPage.updateCogRadarButtons(radar)
    ...
    def setBuildingRadar(self, radar):
        ...
        if hasattr(self, 'suitPage'):
            ...
            self.newSuitPage.updateBuildingRadarButtons(radar)
    ...
    def playSplashEffect(self, x, y, z):
        if localAvatar.zoneId not in [ToontownGlobals.DonaldsDock, ToontownGlobals.OutdoorZone, ToontownGlobals.ConstructionZone] and (not hasattr(localAvatar, 'inEstate') or localAvatar.inEstate != 1):
