...
v2 = (('phone', 'phone', 5),
      ...
      ('glower', 'glower', 5),
      ('magic1', 'magic1', 5))
v3 = (('throw-paper', 'throw-paper', 5),
      ('magic3', 'magic3', 5))
v4 = (('throw-paper', 'throw-paper', 5),
      ('speak', 'speak', 5),
      ('magic2', 'magic2', 5))
v5 = (('glower', 'glower', 5),
      ('fingerwag', 'fingerwag', 5),
      ('smile', 'smile', 5))
rr = (('effort', 'effort', 5),
      ('throw-object', 'throw-object', 5),
      ('throw-paper', 'throw-paper', 5))
v7 = (('throw-paper', 'throw-paper', 5),
      ('magic1', 'magic1', 5),
      ('speak', 'speak', 5))
v8 = (('effort', 'effort', 6),
      ('cigar-smoke', 'cigar-smoke', 8),
...
lr = (('phone', 'phone', 5),
      ...
      ('glower', 'glower', 5),
      ('magic1', 'magic1', 5))
e3 = (('throw-paper', 'throw-paper', 5),
      ('magic3', 'magic3', 5))
e4 = (('throw-paper', 'throw-paper', 5),
      ('speak', 'speak', 5),
      ('magic2', 'magic2', 5))
e5 = (('glower', 'glower', 5),
      ('fingerwag', 'fingerwag', 5),
...
tbh = (('effort', 'effort', 5),
      ...
      ('pen-squirt', 'pen-squirt', 5),
      ('throw-paper', 'throw-paper', 5))
e7 = (('throw-paper', 'throw-paper', 5),
      ('magic1', 'magic1', 5),
      ('speak', 'speak', 5))
fns = (('effort', 'effort', 5),
      ('magic2', 'magic2', 5),
      ('fingerwag', 'fingerwag', 5))
b1 = (('throw-paper', 'throw-paper', 5),
      ('speak', 'speak', 5),
      ('magic1', 'magic1', 5))
b2 = (('phone', 'phone', 5),
      ('throw-paper', 'throw-paper', 5),
      ('glower', 'glower', 5),
      ('magic1', 'magic1', 5))
b3 = (('throw-paper', 'throw-paper', 5),
      ('magic3', 'magic3', 5))
b4 = (('throw-paper', 'throw-paper', 5),
      ('speak', 'speak', 5),
      ('magic2', 'magic2', 5))
b5 = (('glower', 'glower', 5),
      ('fingerwag', 'fingerwag', 5),
...
z2 = (('phone', 'phone', 5),
      ...
      ('glower', 'glower', 5),
      ('magic1', 'magic1', 5))
z3 = (('throw-paper', 'throw-paper', 5),
      ('magic3', 'magic3', 5))
z4 = (('throw-paper', 'throw-paper', 5),
      ('speak', 'speak', 5),
      ('magic2', 'magic2', 5))
z5 = (('glower', 'glower', 5),
      ('fingerwag', 'fingerwag', 5),
...
class Suit(Avatar.Avatar):
    ...
    medallionColors = {'c': Vec4(0.863, 0.776, 0.769, 1.0),
     ...
     'v': Vec4(0.743, 0.722, 0.865, 1.0),
     'e': Vec4(0.962, 0.94, 1, 1),
     'b': Vec4(0.743, 0.722, 0.865, 1.0),
     'z': Vec4(0.962, 0.94, 1, 1)}
    ...
    def makeGold(self):
        ...
        self.setColor(0.9, 0.8, 0, 1)
        parts = self.findAllMatches('**/pPlane*')
        for partNum in xrange(0, parts.getNumPaths()):
            bb = parts.getPath(partNum)
            bb.setTwoSided(1)

        self.setName(TTLocalizer.Gold)
    ...
    def getLoseActor(self):
        if self.loseActor == None:
            if not self.isSkeleton and not self.isGold:
    ...
    def getDialogueArray(self):
        if self.isSkeleton or self.isGold:
            loadSkelDialog()
    ...
    def getTypeText(self):
        if self.virtual:
            ...
            return TTLocalizer.CogPanelGold
