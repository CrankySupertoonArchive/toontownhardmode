...
Levels = [
 [0, 20, 100, 400, 1500, 4500, 8000],
 [0, 20, 100, 400, 1500, 4500, 8000],
 [0, 20, 100, 400, 1500, 4500, 8000],
 [0, 20, 100, 400, 1500, 4500, 8000],
 [0, 20, 50, 250, 1500, 4000, 8000],
 [0, 20, 50, 250, 1500, 4000, 8000],
 [0, 20, 100, 400, 1500, 4500, 8000]
]
regMaxSkill = 8000
...
AvPropAccuracy = (
 ...
 (0, 0, 0, 0, 0, 0, 0),
 (75, 75, 80, 80, 85, 90, 97),
 (95, 95, 95, 95, 95, 95, 99),
 (75, 75, 80, 80, 85, 90, 95),
 (85, 85, 90, 90, 95, 95, 99),
 (75, 75, 80, 80, 85, 90, 95)
)
...
def getFactoryCreditMultiplier(factoryId):
    if factoryId == HardSellbotFactoryInt:
        return 4.0
    return 2.0
...
def getMintCreditMultiplier(mintId):
    return {CashbotMintIntA: 2.0,
     CashbotMintIntB: 3.0,
     CashbotMintIntC: 4.0}.get(mintId, 1.0)
...
def getCountryClubCreditMultiplier(countryClubId):
    return {BossbotCountryClubIntA: 2.0,
     BossbotCountryClubIntB: 3.0,
     BossbotCountryClubIntC: 4.0}.get(countryClubId, 1.0)
