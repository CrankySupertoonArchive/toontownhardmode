...
DeptColors = (Vec4(0.647, 0.608, 0.596, 1.0),
 ...
 Vec4(0.761, 0.678, 0.690, 1.0),
 Vec4(0.325, 0.472, 0.416, 1.0),
 Vec4(0.864, 0.921, 0.907, 1.0),
 Vec4(0.216, 0.738, 0.692, 1.0),
 Vec4(0.253, 0.921, 0.216, 1.0))
...
class DisguisePage(ShtikerPage.ShtikerPage):
    ...
    def load(self):
        ...
        self.frame = DirectFrame(parent=self, relief=None, scale=0.47, pos=(0.05, 1, 0))
        self.bkgd = DirectFrame(parent=self.frame, geom=gui.find('**/base'), relief=None, scale=(0.95, 1, 1))
        ...
        self.billTitle = DirectLabel(parent=self.frame, relief=None, geom=gui.find('**/text_bill_progress'), geom_pos=(0, 0.1, 0))
        self.billTitle.hide()
        self.labReportTitle = DirectLabel(parent=self.frame, relief=None, geom=gui.find('**/text_lab_report_progress'), geom_pos=(0, 0.1, 0))
        self.labReportTitle.hide()
        self.titleDeedTitle = DirectLabel(parent=self.frame, relief=None, geom=gui.find('**/text_title_deed_progress'), geom_pos=(0, 0.1, 0))
        self.titleDeedTitle.hide()
        self.crashLogTitle = DirectLabel(parent=self.frame, relief=None, geom=gui.find('**/text_crash_log_progress'), geom_pos=(0, 0.1, 0))
        self.crashLogTitle.hide()      
        ...
        self.meterFace = DirectLabel(parent=self.frame, relief=None, geom=meterFace, color=self.meterColor, pos=(0.0, 0.0, 0.0))
        self.meterFaceHalf1 = DirectLabel(parent=self.frame, relief=None, geom=meterFaceHalf, color=self.meterActiveColor, pos=(0.0, 0.0, 0.0))
        self.meterFaceHalf2 = DirectLabel(parent=self.frame, relief=None, geom=meterFaceHalf, color=self.meterColor, pos=(0.0, 0.0, 0.0))
        self.frame.hide()
        self.activeTab = 3
        self.updatePage()
        return
    ...
    def doTab(self, index):
        ...
        elif SuitDNA.suitDepts[index] == 'v':
            self.progressTitle = self.billTitle
        elif SuitDNA.suitDepts[index] == 'e':
            self.progressTitle = self.labReportTitle
        elif SuitDNA.suitDepts[index] == 'b':
            self.progressTitle = self.titleDeedTitle
        elif SuitDNA.suitDepts[index] == 'z':
            self.progressTitle = self.crashLogTitle
        else:
            self.progressTitle = self.meritTitle
        self.progressTitle.show()
