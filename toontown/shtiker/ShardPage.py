...
def setupInvasionMarker(node, invasionStatus):
    ...
    if iconStatus == 'c':
        ...
        icon = icons.find('**/GovernIcon').copyTo(markerNode)
    elif dept == 'e':
        icon = icons.find('**/EurekaIcon').copyTo(markerNode)
    elif dept == 'b':
        icon = icons.find('**/BuildIcon').copyTo(markerNode)
    elif dept == 'z':
        icon = icons.find('**/ViralIcon').copyTo(markerNode)      
