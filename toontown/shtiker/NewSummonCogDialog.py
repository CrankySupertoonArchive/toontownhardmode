...
class NewSummonCogDialog(DirectFrame, StateData.StateData):
    notify = DirectNotifyGlobal.directNotify.newCategory('NewSummonCogDialog')
    notify.setInfo(True)
    ...
    def __init__(self, suitIndex):
        ...
        self.initialiseoptions(NewSummonCogDialog)
        self.suitIndex = suitIndex
        base.summonDialog = self
        self.popup = None
        self.suitName = SuitDNA.newSuitHeadTypes[self.suitIndex]
        self.suitFullName = SuitBattleGlobals.NewSuitAttributes[self.suitName]['name']
        return
