...
class FishingTrophy(DirectFrame):
    ...
    def setLevel(self, level):
        ...
        if level == -1:
            ...
            self.bowl.hide()
            self.nameLabel.show()
            self.column.setScale(1.3229, 1.26468, 3.61878)
            self.top.setPos(0, 0, 1.5)
            self.__gold()
        elif level == 6:
            self.trophy.hide()
            self.bowl.show()
            self.bowlTop.setScale(2)
            self.nameLabel.show()
            self.__bronze()
        elif level == 7:
            self.trophy.hide()
            ...
            self.trophy.hide()
            self.bowl.show()
            self.bowlTop.setScale(3)
            self.nameLabel.show()
            self.__gold()
        elif level == 9:
            self.trophy.hide()
            self.bowl.show()
            self.bowlTop.setScale(4)
            self.nameLabel.show()
            self.__sapphire()
    ...
    def __sapphire(self):
        self.bowlTop.setColorScale(0, 0.78, 1, 1)
