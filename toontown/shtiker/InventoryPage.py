...
class InventoryPage(ShtikerPage.ShtikerPage):
    ...
    def createMeritBars(self):
        ...
        for i in xrange(len(SuitDNA.suitDepts)):
            self.meritBars.append(DirectWaitBar(parent=self.trackInfo, relief=DGG.SUNKEN, frameSize=(-1, 1, -0.09, 0.15),
             borderWidth=(0.002, 0.002), scale=0.6, text='', text_scale=0.17, text_fg=(0, 0, 0, 1), text_align=TextNode.ALeft,
             text_pos=(-0.86, -0.025), pos=(0, 0, 0.385 - 0.14 * i), frameColor=(DisguisePage.DeptColors[i][0] * 0.7,
