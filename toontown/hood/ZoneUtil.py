...
def isCogHQZone(zoneId):
    if zoneId >= 10000 and zoneId < 14000:
        return 1
    elif zoneId >=19000 and zoneId < 19999:
        return 2
    else:
        return 0
...
def isHQ(zoneId):
    if zoneId == 2520 or zoneId == 1507 or zoneId == 3508 or zoneId == 4504 or zoneId == 5502 or zoneId == 7503 or zoneId == 9505 or zoneId == 14520:
        return True
    return False

def isPetshop(zoneId):
    if zoneId == 2522 or zoneId == 1510 or zoneId == 3511 or zoneId == 4508 or zoneId == 5505 or zoneId == 7504 or zoneId == 9508 or zoneId == 14522:
        return True
    return False
            ...
            if suffix == 0:
                ...
                if getHoodId(zoneId) == SellbotHQ:
                    if suffix == 600:
                        ...
                        where = 'hardFactoryInterior'
                    elif suffix == 800:
                        where = 'unfairFactoryInterior'
                    else:
...
def getWakeInfo(hoodId = None, zoneId = None):
    ...
    try:
        ...
        if canonicalZoneId == DonaldsDock:
            ...
            showWake = 1
        elif canonicalZoneId == ConstructionZone:
            wakeWaterHeight = CZWakeWaterHeight
            showWake = 1
...
def canWearSuit(zoneId):
    ...
    return zoneId >= DynamicZonesBegin or zoneId in [LawbotHQ, CashbotHQ, SellbotHQ, BossbotHQ, GovernbotHQ]
